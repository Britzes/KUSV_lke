...
;//! \htmlinclude rs232Info.msg.html

(cl:defclass <rs232Info> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass rs232Info (<rs232Info>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <rs232Info>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'rs232Info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rs232_msgs-msg:<rs232Info> is deprecated: use rs232_msgs-msg:rs232Info instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <rs232Info>))
...
(cl:defmethod tm-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:tm-val is deprecated.  Use rs232_msgs-msg:tm instead.")
  (tm m))

(cl:ensure-generic-function 'devmode-val :lambda-list '(m))
(cl:defmethod devmode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:devmode-val is deprecated.  Use rs232_msgs-msg:devmode instead.")
  (devmode m))

(cl:ensure-generic-function 'drvcontmode-val :lambda-list '(m))
(cl:defmethod drvcontmode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:drvcontmode-val is deprecated.  Use rs232_msgs-msg:drvcontmode instead.")
  (drvcontmode m))

(cl:ensure-generic-function 'drvoverridemode-val :lambda-list '(m))
(cl:defmethod drvoverridemode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:drvoverridemode-val is deprecated.  Use rs232_msgs-msg:drvoverridemode instead.")
  (drvoverridemode m))

(cl:ensure-generic-function 'drvservo-val :lambda-list '(m))
(cl:defmethod drvservo-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:drvservo-val is deprecated.  Use rs232_msgs-msg:drvservo instead.")
  (drvservo m))

(cl:ensure-generic-function 'drivepedal-val :lambda-list '(m))
(cl:defmethod drivepedal-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:drivepedal-val is deprecated.  Use rs232_msgs-msg:drivepedal instead.")
  (drivepedal m))

(cl:ensure-generic-function 'targetpedalstr-val :lambda-list '(m))
(cl:defmethod targetpedalstr-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:targetpedalstr-val is deprecated.  Use rs232_msgs-msg:targetpedalstr instead.")
  (targetpedalstr m))

(cl:ensure-generic-function 'inputpedalstr-val :lambda-list '(m))
(cl:defmethod inputpedalstr-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:inputpedalstr-val is deprecated.  Use rs232_msgs-msg:inputpedalstr instead.")
  (inputpedalstr m))

(cl:ensure-generic-function 'targetveloc-val :lambda-list '(m))
(cl:defmethod targetveloc-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:targetveloc-val is deprecated.  Use rs232_msgs-msg:targetveloc instead.")
  (targetveloc m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:speed-val is deprecated.  Use rs232_msgs-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'driveshift-val :lambda-list '(m))
(cl:defmethod driveshift-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:driveshift-val is deprecated.  Use rs232_msgs-msg:driveshift instead.")
  (driveshift m))

(cl:ensure-generic-function 'targetshift-val :lambda-list '(m))
(cl:defmethod targetshift-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:targetshift-val is deprecated.  Use rs232_msgs-msg:targetshift instead.")
  (targetshift m))

(cl:ensure-generic-function 'inputshift-val :lambda-list '(m))
(cl:defmethod inputshift-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:inputshift-val is deprecated.  Use rs232_msgs-msg:inputshift instead.")
  (inputshift m))

(cl:ensure-generic-function 'strmode-val :lambda-list '(m))
(cl:defmethod strmode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:strmode-val is deprecated.  Use rs232_msgs-msg:strmode instead.")
  (strmode m))

(cl:ensure-generic-function 'strcontmode-val :lambda-list '(m))
(cl:defmethod strcontmode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:strcontmode-val is deprecated.  Use rs232_msgs-msg:strcontmode instead.")
  (strcontmode m))

(cl:ensure-generic-function 'stroverridemode-val :lambda-list '(m))
(cl:defmethod stroverridemode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:stroverridemode-val is deprecated.  Use rs232_msgs-msg:stroverridemode instead.")
  (stroverridemode m))

(cl:ensure-generic-function 'strservo-val :lambda-list '(m))
(cl:defmethod strservo-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:strservo-val is deprecated.  Use rs232_msgs-msg:strservo instead.")
  (strservo m))

(cl:ensure-generic-function 'targettorque-val :lambda-list '(m))
(cl:defmethod targettorque-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:targettorque-val is deprecated.  Use rs232_msgs-msg:targettorque instead.")
  (targettorque m))

(cl:ensure-generic-function 'torque-val :lambda-list '(m))
(cl:defmethod torque-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:torque-val is deprecated.  Use rs232_msgs-msg:torque instead.")
  (torque m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:angle-val is deprecated.  Use rs232_msgs-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'targetangle-val :lambda-list '(m))
(cl:defmethod targetangle-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:targetangle-val is deprecated.  Use rs232_msgs-msg:targetangle instead.")
  (targetangle m))

(cl:ensure-generic-function 'bbrakepress-val :lambda-list '(m))
(cl:defmethod bbrakepress-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:bbrakepress-val is deprecated.  Use rs232_msgs-msg:bbrakepress instead.")
  (bbrakepress m))

(cl:ensure-generic-function 'brakepedal-val :lambda-list '(m))
(cl:defmethod brakepedal-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:brakepedal-val is deprecated.  Use rs232_msgs-msg:brakepedal instead.")
  (brakepedal m))

(cl:ensure-generic-function 'brtargetpedalstr-val :lambda-list '(m))
(cl:defmethod brtargetpedalstr-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:brtargetpedalstr-val is deprecated.  Use rs232_msgs-msg:brtargetpedalstr instead.")
  (brtargetpedalstr m))

(cl:ensure-generic-function 'brinputpedalstr-val :lambda-list '(m))
(cl:defmethod brinputpedalstr-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:brinputpedalstr-val is deprecated.  Use rs232_msgs-msg:brinputpedalstr instead.")
  (brinputpedalstr m))

(cl:ensure-generic-function 'battery-val :lambda-list '(m))
(cl:defmethod battery-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:battery-val is deprecated.  Use rs232_msgs-msg:battery instead.")
  (battery m))

(cl:ensure-generic-function 'voltage-val :lambda-list '(m))
(cl:defmethod voltage-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:voltage-val is deprecated.  Use rs232_msgs-msg:voltage instead.")
  (voltage m))

(cl:ensure-generic-function 'anp-val :lambda-list '(m))
(cl:defmethod anp-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:anp-val is deprecated.  Use rs232_msgs-msg:anp instead.")
  (anp m))

(cl:ensure-generic-function 'battmaxtemparature-val :lambda-list '(m))
(cl:defmethod battmaxtemparature-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:battmaxtemparature-val is deprecated.  Use rs232_msgs-msg:battmaxtemparature instead.")
  (battmaxtemparature m))

(cl:ensure-generic-function 'battmintemparature-val :lambda-list '(m))
(cl:defmethod battmintemparature-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:battmintemparature-val is deprecated.  Use rs232_msgs-msg:battmintemparature instead.")
  (battmintemparature m))

(cl:ensure-generic-function 'maxchgcurrent-val :lambda-list '(m))
(cl:defmethod maxchgcurrent-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:maxchgcurrent-val is deprecated.  Use rs232_msgs-msg:maxchgcurrent instead.")
  (maxchgcurrent m))

(cl:ensure-generic-function 'maxdischgcurrent-val :lambda-list '(m))
(cl:defmethod maxdischgcurrent-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:maxdischgcurrent-val is deprecated.  Use rs232_msgs-msg:maxdischgcurrent instead.")
  (maxdischgcurrent m))

(cl:ensure-generic-function 'sideacc-val :lambda-list '(m))
(cl:defmethod sideacc-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:sideacc-val is deprecated.  Use rs232_msgs-msg:sideacc instead.")
  (sideacc m))

(cl:ensure-generic-function 'accellfromp-val :lambda-list '(m))
(cl:defmethod accellfromp-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:accellfromp-val is deprecated.  Use rs232_msgs-msg:accellfromp instead.")
  (accellfromp m))

(cl:ensure-generic-function 'anglefromp-val :lambda-list '(m))
(cl:defmethod anglefromp-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:anglefromp-val is deprecated.  Use rs232_msgs-msg:anglefromp instead.")
  (anglefromp m))

(cl:ensure-generic-function 'brakepedalfromp-val :lambda-list '(m))
(cl:defmethod brakepedalfromp-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:brakepedalfromp-val is deprecated.  Use rs232_msgs-msg:brakepedalfromp instead.")
  (brakepedalfromp m))

(cl:ensure-generic-function 'speedfr-val :lambda-list '(m))
(cl:defmethod speedfr-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:speedfr-val is deprecated.  Use rs232_msgs-msg:speedfr instead.")
  (speedfr m))

(cl:ensure-generic-function 'speedfl-val :lambda-list '(m))
(cl:defmethod speedfl-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:speedfl-val is deprecated.  Use rs232_msgs-msg:speedfl instead.")
  (speedfl m))

(cl:ensure-generic-function 'speedrr-val :lambda-list '(m))
(cl:defmethod speedrr-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:speedrr-val is deprecated.  Use rs232_msgs-msg:speedrr instead.")
  (speedrr m))

(cl:ensure-generic-function 'speedrl-val :lambda-list '(m))
(cl:defmethod speedrl-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:speedrl-val is deprecated.  Use rs232_msgs-msg:speedrl instead.")
  (speedrl m))

(cl:ensure-generic-function 'velocfromp2-val :lambda-list '(m))
(cl:defmethod velocfromp2-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:velocfromp2-val is deprecated.  Use rs232_msgs-msg:velocfromp2 instead.")
  (velocfromp2 m))

(cl:ensure-generic-function 'drvmode-val :lambda-list '(m))
(cl:defmethod drvmode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:drvmode-val is deprecated.  Use rs232_msgs-msg:drvmode instead.")
  (drvmode m))

(cl:ensure-generic-function 'devpedalstrfromp-val :lambda-list '(m))
(cl:defmethod devpedalstrfromp-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:devpedalstrfromp-val is deprecated.  Use rs232_msgs-msg:devpedalstrfromp instead.")
  (devpedalstrfromp m))

(cl:ensure-generic-function 'rpm-val :lambda-list '(m))
(cl:defmethod rpm-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:rpm-val is deprecated.  Use rs232_msgs-msg:rpm instead.")
  (rpm m))

(cl:ensure-generic-function 'velocflfromp-val :lambda-list '(m))
(cl:defmethod velocflfromp-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:velocflfromp-val is deprecated.  Use rs232_msgs-msg:velocflfromp instead.")
  (velocflfromp m))

(cl:ensure-generic-function 'ev_mode-val :lambda-list '(m))
(cl:defmethod ev_mode-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:ev_mode-val is deprecated.  Use rs232_msgs-msg:ev_mode instead.")
  (ev_mode m))

(cl:ensure-generic-function 'temp-val :lambda-list '(m))
(cl:defmethod temp-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:temp-val is deprecated.  Use rs232_msgs-msg:temp instead.")
  (temp m))

(cl:ensure-generic-function 'shiftfrmprius-val :lambda-list '(m))
(cl:defmethod shiftfrmprius-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:shiftfrmprius-val is deprecated.  Use rs232_msgs-msg:shiftfrmprius instead.")
  (shiftfrmprius m))

(cl:ensure-generic-function 'light-val :lambda-list '(m))
(cl:defmethod light-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:light-val is deprecated.  Use rs232_msgs-msg:light instead.")
  (light m))

(cl:ensure-generic-function 'gaslevel-val :lambda-list '(m))
(cl:defmethod gaslevel-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:gaslevel-val is deprecated.  Use rs232_msgs-msg:gaslevel instead.")
  (gaslevel m))

(cl:ensure-generic-function 'door-val :lambda-list '(m))
(cl:defmethod door-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:door-val is deprecated.  Use rs232_msgs-msg:door instead.")
  (door m))

(cl:ensure-generic-function 'cluise-val :lambda-list '(m))
(cl:defmethod cluise-val ((m <rs232Info>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:cluise-val is deprecated.  Use rs232_msgs-msg:cluise instead.")
  (cluise m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <rs232Info>) ostream)
  "Serializes a message object of type '<rs232Info>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <rs232Info>) istream)
  "Deserializes a message object of type '<rs232Info>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<rs232Info>)))
  "Returns string type for a message object of type '<rs232Info>"
  "rs232_msgs/rs232Info")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rs232Info)))
  "Returns string type for a message object of type 'rs232Info"
  "rs232_msgs/rs232Info")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<rs232Info>)))
  "Returns md5sum for a message object of type '<rs232Info>"
  "605f4356821f92a8fec1a756259316df")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'rs232Info)))
  "Returns md5sum for a message object of type 'rs232Info"
  "605f4356821f92a8fec1a756259316df")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<rs232Info>)))
  "Returns full string definition for message of type '<rs232Info>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'rs232Info)))
  "Returns full string definition for message of type 'rs232Info"
  (cl:format cl:nil "Header header~%string tm~%int32 devmode~%int32 drvcontmode~%int32 drvoverridemode~%int32 drvservo~%int32 drivepedal~%int32 targetpedalstr~%int32 inputpedalstr~%float64 targetveloc~%float64 speed~%int32 driveshift~%int32 targetshift~%int32 inputshift~%int32 strmode~%int32 strcontmode~%int32 stroverridemode~%int32 strservo~%int32 targettorque~%int32 torque~%float64 angle~%float64 targetangle~%int32 bbrakepress~%int32 brakepedal~%int32 brtargetpedalstr~%int32 brinputpedalstr~%float64 battery~%int32 voltage~%float64 anp~%int32 battmaxtemparature~%int32 battmintemparature~%float64 maxchgcurrent~%float64 maxdischgcurrent~%float64 sideacc~%float64 accellfromp~%float64 anglefromp~%float64 brakepedalfromp~%float64 speedfr~%float64 speedfl~%float64 speedrr~%float64 speedrl~%float64 velocfromp2~%int32 drvmode~%int32 devpedalstrfromp~%int32 rpm~%float64 velocflfromp~%int32 ev_mode~%int32 temp~%int32 shiftfrmprius~%int32 light~%int32 gaslevel~%int32 door~%int32 cluise~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <rs232Info>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <rs232Info>))
