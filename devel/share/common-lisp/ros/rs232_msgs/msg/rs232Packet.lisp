...
;//! \htmlinclude rs232Packet.msg.html

(cl:defclass <rs232Packet> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass rs232Packet (<rs232Packet>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <rs232Packet>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'rs232Packet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rs232_msgs-msg:<rs232Packet> is deprecated: use rs232_msgs-msg:rs232Packet instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <rs232Packet>))
...
(cl:defmethod count-val ((m <rs232Packet>))
...
(cl:defmethod id-val ((m <rs232Packet>))
...
(cl:defmethod len-val ((m <rs232Packet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:len-val is deprecated.  Use rs232_msgs-msg:len instead.")
  (len m))

(cl:ensure-generic-function 'dat-val :lambda-list '(m))
(cl:defmethod dat-val ((m <rs232Packet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rs232_msgs-msg:dat-val is deprecated.  Use rs232_msgs-msg:dat instead.")
  (dat m))

(cl:ensure-generic-function 'flag-val :lambda-list '(m))
(cl:defmethod flag-val ((m <rs232Packet>))
...
(cl:defmethod time-val ((m <rs232Packet>))
  ...
  (time m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <rs232Packet>) ostream)
  "Serializes a message object of type '<rs232Packet>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <rs232Packet>) istream)
  "Deserializes a message object of type '<rs232Packet>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<rs232Packet>)))
  "Returns string type for a message object of type '<rs232Packet>"
  "rs232_msgs/rs232Packet")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'rs232Packet)))
  "Returns string type for a message object of type 'rs232Packet"
  "rs232_msgs/rs232Packet")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<rs232Packet>)))
  "Returns md5sum for a message object of type '<rs232Packet>"
  "8315bda71683b8ece50e17e529eea4c1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'rs232Packet)))
  "Returns md5sum for a message object of type 'rs232Packet"
  "8315bda71683b8ece50e17e529eea4c1")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<rs232Packet>)))
  "Returns full string definition for message of type '<rs232Packet>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'rs232Packet)))
  "Returns full string definition for message of type 'rs232Packet"
  (cl:format cl:nil "Header header~%uint32 count~%uint32 id~%uint8  len~%uint8[8]  dat~%uint16 flag~%uint32 time~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <rs232Packet>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <rs232Packet>))
