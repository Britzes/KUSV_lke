// Generated by gencpp from file rs232_msgs/rs232Info.msg
// DO NOT EDIT!


#ifndef RS232_MSGS_MESSAGE_RS232INFO_H
#define RS232_MSGS_MESSAGE_RS232INFO_H
...
struct rs232Info_
{
  typedef rs232Info_<ContainerAllocator> Type;
  ...
  rs232Info_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , tm(_alloc)
    , devmode(0)
    , drvcontmode(0)
  ...
  typedef boost::shared_ptr< ::rs232_msgs::rs232Info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rs232_msgs::rs232Info_<ContainerAllocator> const> ConstPtr;

}; // struct rs232Info_

typedef ::rs232_msgs::rs232Info_<std::allocator<void> > rs232Info;

typedef boost::shared_ptr< ::rs232_msgs::rs232Info > rs232InfoPtr;
typedef boost::shared_ptr< ::rs232_msgs::rs232Info const> rs232InfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rs232_msgs::rs232Info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rs232_msgs::rs232Info_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::rs232_msgs::rs232Info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rs232_msgs::rs232Info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rs232_msgs::rs232Info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rs232_msgs::rs232Info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rs232_msgs::rs232Info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rs232_msgs::rs232Info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rs232_msgs::rs232Info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rs232_msgs::rs232Info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x605f4356821f92a8ULL;
  static const uint64_t static_value2 = 0xfec1a756259316dfULL;
};

template<class ContainerAllocator>
struct DataType< ::rs232_msgs::rs232Info_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rs232_msgs::rs232Info_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rs232_msgs::rs232Info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rs232_msgs::rs232Info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rs232_msgs::rs232Info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // RS232_MSGS_MESSAGE_RS232INFO_H
